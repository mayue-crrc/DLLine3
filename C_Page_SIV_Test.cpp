...
ROMDATA g_PicRom_AccessorySystemTest[] =
{
    ...
    D_COMMON_PAGE_HEADER_NEW_DL(QSTR(" 辅助系统检查") )
    {"",                          D_FONT_BOLD(10),      QRect(100, 64, 600,  85),          Qt::black,                QColor(205,205,205),                 CONTROL_TRAIN,          ID_ACCESSORYSYSTEM_TRAIN                      },
    {"RIGHT",                  D_FONT_BOLD(6),      QRect(700+2, 107,  45,  20),          Qt::white,                Qt::white,                CONTROL_ARROW,          ID_ACCESSORYSYSTEM_ARROW_RIGHT                },
    {"LEFT",                   D_FONT_BOLD(6),      QRect( 40, 107,  45,  20),          Qt::white,                Qt::white,                CONTROL_ARROW,          ID_ACCESSORYSYSTEM_ARROW_LEFT                 },
#endif
    ...
    {QSTR("1"),                    D_FONT_BOLD(8),      QRect(101,  170+10,  150, 30),           Qt::white,                Qt::transparent,          CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("2"),                    D_FONT_BOLD(8),      QRect(251,  170+10,  150, 30),           Qt::white,                Qt::transparent,          CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("3"),                    D_FONT_BOLD(8),      QRect(401,  170+10,  150, 30),           Qt::white,                Qt::transparent,          CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("4"),                    D_FONT_BOLD(8),      QRect(551,  170+10,  150, 30),           Qt::white,                Qt::transparent,          CONTROL_LABEL,          ID_IGNORE         },
...
//    {QSTR("8"),                    D_FONT_BOLD(8),      QRect(628,  170+10,  70, 30),           Qt::white,                Qt::transparent,          CONTROL_LABEL,          ID_IGNORE         },
    ...
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(105, 201+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_VCAR1   },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(255, 201+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(405, 201+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
...
//    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(553, 201+10,  70,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(555, 201+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_VCAR6   },

    {QSTR("输出电流"),               D_FONT_BOLD(8),      QRect(11, 241+10, 88,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(105, 241+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_ACAR1   },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(255, 241+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(405, 241+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
...
//    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(553, 241+10,  70,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(555, 241+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_ACAR6   },

    {QSTR("可复位故障"),             D_FONT_BOLD(8),      QRect(11, 281+10, 88,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(105, 281+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_RCAR1   },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(255, 281+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(405, 281+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
...
//    {QSTR("-"),                     D_FONT_BOLD(8),      QRect(553, 281+10,  70,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_IGNORE         },
    {QSTR(""),                      D_FONT_BOLD(8),      QRect(555, 281+10,  140,  38),           Qt::white,                Qt::black,                CONTROL_LABEL,          ID_ACCESSORYSYSTEM_LABEL_RCAR6   },
...
void CAccessorySystemTestPage::OnUpdatePage()
{
    ...
    updateErrorLine(ID_ACCESSORYSYSTEM_TRAIN);//3.5
